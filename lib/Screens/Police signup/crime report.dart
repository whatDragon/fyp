                      ...
                      children: [
                        ...
                        Container(
                          ...
                          validator: (value) {
                            ...
                            decoration: ThemeHelper().textInputDecoration('Full Name', 'Enter your Name'),
                          ),
                        ...
                        Container(
                          ...
                          validator: (value) {
                            ...
                            decoration: ThemeHelper().textInputDecoration('Home Address', 'Enter your house address'),
                          ),
                          decoration: ThemeHelper().inputBoxDecorationShaddow(),
                        ),
                       ...
                       const SizedBox(height: 30,),
                        ...
                        const SizedBox(height: 15.0),
                        const Text("Police Notified ",style: TextStyle(fontWeight: FontWeight.bold),),
                        FormField<bool>(
                          builder: (state) {
                            return Column(
